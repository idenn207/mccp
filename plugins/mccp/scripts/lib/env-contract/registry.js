...
const RAW = [
  ...
  ['MCCP_STOP_LOOP', 'enum', ['off', 'observe', 'enforce'], 'observe', null, 'active', 'gates', 'plugins/mccp/scripts/hooks/stop-review-loop.js:47', 'Stop-loop 게이트 모드.'],
  ...
  ['MCCP_GOAL_FEATURE', 'enum', ['available', 'missing', 'unknown'], null, null, 'active', 'gates', 'plugins/mccp/scripts/lib/goal-detect.js:59', 'native /goal 가용성 강제.'],
  ['MCCP_ULTRACODE_FEATURE', 'enum', ['available', 'missing', 'unknown'], null, null, 'active', 'gates', 'plugins/mccp/scripts/lib/ultracode-detect.js:50', 'ultracode 가용성 강제.'],

  // ── review — plan-review L1/L2/L3 · santa · 단일통과 · intent · design ─────
  ['MCCP_PLAN_REVIEW', 'enum', ['off', 'multi-agent', 'codex', 'hybrid'], 'multi-agent', null, 'active', 'review', 'plugins/mccp/scripts/lib/plan-review/decide.js:50', 'plan 승인 리뷰 소스.'],
  ...
  ['MCCP_REVIEW_SINGLE_PASS', 'enum', ['scope_too_small', 'deadline_pressure', 'deferred_to_prd_completion'], null, null, 'active', 'review', 'plugins/mccp/scripts/lib/review-single-pass.js:21', '리뷰 단일통과 + 사유.'],
  ...
  ['MCCP_SANTA_SEVERITY_GATE', 'enum', ['off', 'high', 'critical'], null, null, 'undocumented-default', 'review', 'plugins/mccp/scripts/lib/santa/gate.js:81', 'santa 차단 최소 severity.'],
  ['MCCP_SANTA_TERMINATOR', 'enum', ['off', 'on'], null, null, 'undocumented-default', 'review', 'plugins/mccp/scripts/lib/santa/terminator.js:18', 'santa 종료 판정기.'],
  ['MCCP_SANTA_ADJUDICATION_GATE', 'enum', ['off', 'warn', 'enforce'], null, null, 'undocumented-default', 'review', 'plugins/mccp/scripts/lib/santa/adjudication.js:40', 'santa 심판 게이트 모드.'],
  ['MCCP_SANTA_LEDGER_SUPPRESSION', 'enum', ['off', 'on'], null, null, 'undocumented-default', 'review', 'plugins/mccp/scripts/lib/santa/adjudication.js:41', 'santa 원장 억제.'],
  ['MCCP_SANTA_BLIND_LANE', 'enum', ['a', 'b', 'off'], 'a', null, 'active', 'review', 'plugins/mccp/scripts/lib/santa/lanes.js:32', 'santa 증거 레인 배정.'],
  ['MCCP_SANTA_ALWAYS_SCOPE', 'enum', ['enforce', 'off'], 'enforce', null, 'active', 'review', 'plugins/mccp/scripts/lib/santa/scope-always.js:27', 'santa 상시 스코프 + 정합 rubric.'],
  ['MCCP_SANTA_DELTA_SCOPE', 'enum', ['enforce', 'off'], 'off', null, 'active', 'review', 'plugins/mccp/scripts/lib/santa/scope-delta.js:19', 'santa 델타 스코프 축소 (default가 형제와 반대 — off).'],
  ['MCCP_SANTA_DEGRADE_GATE', 'enum', ['enforce', 'off'], 'enforce', null, 'active', 'review', 'plugins/mccp/scripts/lib/santa/model-diversity.js:28', 'santa 모델 계열 degrade 강등.'],
  ...
  ['MCCP_WORK_MERGE_STRATEGY', 'enum', ['worktree-merge', 'sequential'], 'worktree-merge', null, 'active', 'orchestration', 'plugins/mccp/scripts/lib/orchestration-preview.js:70', 'worker 산출물 병합 전략.'],
  ['MCCP_WORK_MERGED_VERIFY', 'enum', ['enforce', 'warn', 'off'], 'enforce', null, 'active', 'orchestration', 'plugins/mccp/scripts/lib/implement-dispatch/verify.js:38', '병합 후 verify 모드.'],
  ...
  ['MCCP_PLAN_FANOUT_AUTODISABLE_TIER', 'list', null, '', null, 'active', 'orchestration', 'plugins/mccp/scripts/lib/plan-fanout/budget.js:85', 'fan-out 자동 해제 tier.'],
  ...
  ['MCCP_HANDOFF_THRESHOLDS_USD', 'list', null, '50,80,100', null, 'active', 'cost', 'plugins/mccp/scripts/lib/cost-thresholds.js:23', '핸드오프 임계 USD 3단계.'],
  ...
  ['MCCP_BRIEFING', 'enum', ['auto', 'off', 'always'], 'auto', null, 'active', 'cost', 'plugins/mccp/scripts/lib/briefing/cost-guard.js:75', 'briefing stamp 정책.'],
  ['MCCP_BRIEFING_AUTODISABLE_TIER', 'list', null, 'notice,warning,critical', null, 'active', 'cost', 'plugins/mccp/scripts/lib/briefing/cost-guard.js:102', 'briefing 자동 해제 tier.'],
  ['MCCP_CONTEXT_MONITOR_COST_MODE', 'enum', ['off', 'observe', 'enforce'], null, null, 'undocumented-default', 'cost', 'plugins/mccp/scripts/hooks/ecc-context-monitor.js:61', '비용 모니터 모드.'],
  ...
  ['MCCP_HOOK_PROFILE', 'enum', ['full', 'lean', 'minimal'], null, null, 'undocumented-default', 'hooks', 'plugins/mccp/scripts/lib/hook-flags.js:19', 'hook 무게 프로파일.'],
  ['MCCP_DISABLED_HOOKS', 'list', null, null, null, 'undocumented-default', 'hooks', 'plugins/mccp/scripts/lib/hook-flags.js:24', '비활성 hook id 목록.'],
  ...
  ['MCCP_MCP_CONFIG_PATH', 'list', null, null, null, 'undocumented-default', 'hooks', 'plugins/mccp/scripts/hooks/mcp-health-check.js:55', 'MCP 설정 경로 목록.'],
  ...
  ['MCCP_STATE_JOURNAL', 'enum', ['off', 'on'], null, null, 'undocumented-default', 'observability', 'plugins/mccp/scripts/lib/state-journal/index.js:29', 'STATE.md 저널 기록.'],
  ['MCCP_EVIDENCE_CONFLICT_GUARD', 'enum', ['enforce', 'warn', 'off'], 'enforce', null, 'active', 'observability', 'plugins/mccp/scripts/receipt/evidence-lock.js:99', '중복 claim 가드 모드.'],
  ['MCCP_EVIDENCE_STAGE_ROOT', 'list', null, null, null, 'undocumented-default', 'observability', 'plugins/mccp/scripts/lib/evidence-stage-guard.js:154', '증거 스테이징 루트.'],
  ['MCCP_SESSION_LEDGER_SCOPE', 'enum', ['repo', 'host', 'global'], null, null, 'undocumented-default', 'observability', 'plugins/mccp/scripts/state/session-ledger.js:210', '세션 원장 조회 범위.'],
