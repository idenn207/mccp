...
| 4 | 대시보드 액션 버튼 (후속) | 대시보드에서 위험 '제외(obsolete)'를 same-origin POST→소스 `.md` 마커로 비파괴 기록하고 렌더가 collapse한다. claude 미실행. | complete | `.claude/plans/dashboard-interactivity-m4.plan.md` |
