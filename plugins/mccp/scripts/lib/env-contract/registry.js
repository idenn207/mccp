...
const RAW = [
  ...
  ['MCCP_AUTO_CHAIN_SKIP_PR', 'bypass-flag', BY, 'off', OFF, 'active', 'gates', 'plugins/mccp/commands/prp-implement.md:1616', 'commit까지만, PR 생략 — LLM이 읽고 판단하며 기계 강제가 없다.'],
  ...
  ['MCCP_PLAN_REVIEW_QUORUM', 'string', null, '3of4', null, 'active', 'review', 'plugins/mccp/scripts/lib/plan-review/quorum.js:44', '수렴에 필요한 승인 수 — 3of4 형식.'],
  ...
  ['MCCP_BRIEFING', 'enum', ['auto', 'off'], 'auto', null, 'active', 'cost', 'plugins/mccp/scripts/lib/briefing/cost-guard.js:82', 'briefing stamp 정책.', 'plugins/mccp/scripts/lib/briefing/cost-guard.js#BRIEFING_VALUES'],
