...
|---|---|---|---|---|
| 1 | Subscription opt-in gate | `MCCP_SUBSCRIPTION=1` 시 5개 소비처가 USD 게이트를 우회하고 폭주 방지를 context/turn 축으로 대체 — 구독권 사용자의 자동화 잠금 즉시 해제 | in-progress | `.claude/plans/cost-model-subscription-m1.plan.md` |
