...
| 4 | 메인 표현 정리 | 타임라인 '더보기'(상위 N expanded + 나머지 접힘) + 미해결질문은 메인에 복사 버튼만(상세는 드로어) + 위험에 복사 버튼 추가. | in-progress | `.claude/plans/dashboard-truthfulness-m4-surface-cleanup.plan.md` |
