...
function showHelp() {
  process.stdout.write([
    ...
    '',
    'Subcommands (Phase 1 — foundation only):',
    ...
    '',
    'Subcommands (Phase 2 — receipt CLI core, not yet implemented):',
    '  write       --gate <id> --decision <slug> --plan <path> ...',
    '  validate    --command <slug>',
    '  preflight   --command <slug>',
    '  status      [--phase <p>]',
    '  diff        --plan <path> --against <receipt.json>',
    '',
    'Subcommands (Phase 5 — fallback, not yet implemented):',
