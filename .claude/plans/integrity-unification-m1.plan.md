...
| M3 | terminal `/mccp:pr` non-approving mechanical hard-stop 재설계(2026-07-21 HIGH) — bounded orchestration·re-entrancy·lock·crash-window·self-receipt 포함 semantics + absent-verdict fail-closed(Codex R1 F2) + 자체 version bump·acceptance gates | in-progress | `.claude/plans/integrity-unification-m3.plan.md` |
