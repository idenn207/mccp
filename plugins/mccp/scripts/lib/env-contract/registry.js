...
const RAW = [
  ...
  ['MCCP_RECEIPT_GATE_MODE', 'enum', ['hard', 'soft', 'off'], 'hard', null, 'active', 'gates', 'plugins/mccp/scripts/hooks/receipt-prompt.js:217', 'receipt 게이트 강도.', 'plugins/mccp/scripts/lib/receipt-mode.js#VALID_MODES'],
  ...
  ['MCCP_STOP_LOOP', 'enum', ['off', 'observe', 'enforce'], 'observe', null, 'active', 'gates', 'plugins/mccp/scripts/hooks/stop-review-loop.js:47', 'Stop-loop 게이트 모드.', null, '수용 어휘가 명명 상수 없이 인라인 비교로만 존재한다 (stop-review-loop.js) — M2 문서화 축이 상수로 승격한다'],
  ...
  ['MCCP_GOAL_FEATURE', 'enum', ['available', 'missing', 'unknown'], null, null, 'active', 'gates', 'plugins/mccp/scripts/lib/goal-detect.js:59', 'native /goal 가용성 강제.', null, '수용 어휘가 명명 상수 없이 인라인 비교로만 존재한다 (goal-detect.js) — M2 문서화 축이 상수로 승격한다'],
  ['MCCP_ULTRACODE_FEATURE', 'enum', ['available', 'missing', 'unknown'], null, null, 'active', 'gates', 'plugins/mccp/scripts/lib/ultracode-detect.js:50', 'ultracode 가용성 강제.', null, '수용 어휘가 명명 상수 없이 인라인 비교로만 존재한다 (ultracode-detect.js) — M2 문서화 축이 상수로 승격한다'],

  // ── review — plan-review L1/L2/L3 · santa · 단일통과 · intent · design ─────
  ['MCCP_PLAN_REVIEW', 'enum', ['off', 'multi-agent', 'codex', 'hybrid'], 'multi-agent', null, 'active', 'review', 'plugins/mccp/scripts/lib/plan-review/decide.js:50', 'plan 승인 리뷰 소스.', 'plugins/mccp/scripts/lib/plan-review/decide.js#MODES'],
  ...
  ['MCCP_PLAN_REVIEW_QUORUM', 'int', null, null, null, 'undocumented-default', 'review', 'plugins/mccp/scripts/lib/plan-review/quorum.js:22', '수렴에 필요한 승인 수.'],
  ...
  ['MCCP_SANTA_SEVERITY_GATE', 'enum', ['off', 'high', 'critical'], null, null, 'undocumented-default', 'review', 'plugins/mccp/scripts/lib/santa/gate.js:81', 'santa 차단 최소 severity.', 'plugins/mccp/scripts/lib/santa/gate.js#SEVERITY_GATE_VALUES'],
  ['MCCP_SANTA_TERMINATOR', 'enum', ['off', 'on'], null, null, 'undocumented-default', 'review', 'plugins/mccp/scripts/lib/santa/terminator.js:18', 'santa 종료 판정기.', 'plugins/mccp/scripts/lib/santa/terminator.js#TERMINATOR_VALUES'],
  ['MCCP_SANTA_ADJUDICATION_GATE', 'enum', ['off', 'warn', 'enforce'], null, null, 'undocumented-default', 'review', 'plugins/mccp/scripts/lib/santa/adjudication.js:40', 'santa 심판 게이트 모드.', 'plugins/mccp/scripts/lib/santa/adjudication.js#GATE_VALUES'],
  ['MCCP_SANTA_LEDGER_SUPPRESSION', 'enum', ['off', 'on'], null, null, 'undocumented-default', 'review', 'plugins/mccp/scripts/lib/santa/adjudication.js:41', 'santa 원장 억제.', 'plugins/mccp/scripts/lib/santa/adjudication.js#GATE_VALUES'],
  ['MCCP_SANTA_BLIND_LANE', 'enum', ['a', 'b', 'off'], 'a', null, 'active', 'review', 'plugins/mccp/scripts/lib/santa/lanes.js:26', 'santa 증거 레인 배정.', 'plugins/mccp/scripts/lib/santa/lanes.js#BLIND_LANE_VALUES'],
  ...
  ['MCCP_IMPECCABLE_ROUTING_MODE', 'enum', ['auto', 'hybrid', 'recommend'], 'auto', null, 'active', 'review', 'plugins/mccp/scripts/lib/impeccable-routing.js:118', 'impeccable 라우팅 모드.', 'plugins/mccp/scripts/lib/impeccable-routing.js#ROUTING_MODES'],
  ['MCCP_IMPECCABLE_INTENT_COMMANDS', 'list', null, null, null, 'undocumented-default', 'review', 'plugins/mccp/scripts/lib/impeccable-routing.js:127', '추가 라우팅 명령 목록.', 'plugins/mccp/scripts/lib/impeccable-routing.js#MOOD_COMMANDS'],
  ...
  ['MCCP_WORK_MERGE_STRATEGY', 'enum', ['worktree-merge', 'sequential'], 'worktree-merge', null, 'active', 'orchestration', 'plugins/mccp/scripts/lib/orchestration-preview.js:70', 'worker 산출물 병합 전략.', null, '수용 어휘가 명명 상수 없이 인라인 비교로만 존재한다 (orchestration-preview.js) — M2 문서화 축이 상수로 승격한다'],
  ...
  ['MCCP_BRIEFING', 'enum', ['auto', 'off', 'always'], 'auto', null, 'active', 'cost', 'plugins/mccp/scripts/lib/briefing/cost-guard.js:75', 'briefing stamp 정책.', null, 'cost-guard.js가 `=== \'off\'` 한 값만 비교하고 나머지는 기본 경로로 흘린다 — 수용 집합이 열거로 존재하지 않는다'],
  ['MCCP_BRIEFING_AUTODISABLE_TIER', 'list', null, 'notice,warning,critical', null, 'active', 'cost', 'plugins/mccp/scripts/lib/briefing/cost-guard.js:102', 'briefing 자동 해제 tier.', 'plugins/mccp/scripts/lib/briefing/cost-guard.js#allowed'],
  ['MCCP_CONTEXT_MONITOR_COST_MODE', 'enum', ['off', 'observe', 'enforce'], null, null, 'undocumented-default', 'cost', 'plugins/mccp/scripts/hooks/ecc-context-monitor.js:61', '비용 모니터 모드.', null, '수용 어휘가 명명 상수 없이 인라인 비교로만 존재한다 (ecc-context-monitor.js) — M2 문서화 축이 상수로 승격한다'],
  ...
  ['MCCP_HOOK_PROFILE', 'enum', ['full', 'lean', 'minimal'], null, null, 'undocumented-default', 'hooks', 'plugins/mccp/scripts/lib/hook-flags.js:19', 'hook 무게 프로파일.', 'plugins/mccp/scripts/lib/hook-flags.js#VALID_PROFILES'],
  ...
  ['MCCP_SESSION_START_CONTEXT', 'enum', ['off', 'on'], null, null, 'undocumented-default', 'hooks', 'plugins/mccp/scripts/hooks/session-start.js:167', 'STATE.md 주입 여부.', null, '수용 어휘가 명명 상수 없이 인라인 비교로만 존재한다 (session-start.js) — M2 문서화 축이 상수로 승격한다'],
  ...
  ['MCCP_STATE_JOURNAL', 'enum', ['off', 'on'], null, null, 'undocumented-default', 'observability', 'plugins/mccp/scripts/lib/state-journal/index.js:29', 'STATE.md 저널 기록.', 'plugins/mccp/scripts/lib/state-journal/index.js#JOURNAL_MODES'],
  ['MCCP_EVIDENCE_CONFLICT_GUARD', 'enum', ['enforce', 'warn', 'off'], 'enforce', null, 'active', 'observability', 'plugins/mccp/scripts/receipt/evidence-lock.js:99', '중복 claim 가드 모드.', null, '수용 어휘가 명명 상수 없이 인라인 비교로만 존재한다 (evidence-lock.js) — M2 문서화 축이 상수로 승격한다'],
  ...
  ['MCCP_SESSION_LEDGER_SCOPE', 'enum', ['repo', 'host', 'global'], null, null, 'undocumented-default', 'observability', 'plugins/mccp/scripts/state/session-ledger.js:210', '세션 원장 조회 범위.', 'plugins/mccp/scripts/state/session-ledger.js#VALID_SCOPES'],
...
function build() {
  ...
  RAW.forEach(function (row) {
    ...
    // 어휘 필드의 형태 계약. **의미** 검사(ref가 실재하는가, 집합이 같은가)는 L10이
