...
|---|---|---|
| 카드 도입이 anti-ref(hero-metric/identical grid)로 표류 | 중 | 가변 목적 카드 + 거대숫자 금지 + 카드중첩 금지(H17) mechanical lint |<!--mccp:resolved reason="resolved: H17 non-nested + H6 no-giant-number lint, purposeful cards, PR #56 1312099 (design-invariants.test)" at="2026-07-01T06:13:17.187Z"-->
| 2D 레이아웃이 console-noise(Bloomberg)로 표류 | 중 | low-chroma 다크 + accent ≤1 + Calm 톤; impeccable critique/audit 게이트 |<!--mccp:resolved reason="resolved: low-chroma dark console, design critique CONVERGED, PR #56 1312099" at="2026-07-01T06:13:17.187Z"-->
| 다크-default 반전이 light a11y 회귀 | 중 | a11y-contrast.test.js 양 theme 검증 |<!--mccp:resolved reason="resolved: a11y-contrast.test covers T_LIGHT and T_DARK at WCAG AA, 19/19 pass" at="2026-07-01T06:13:17.187Z"-->
...
| M3 스코프가 M4(drawer/nav동작)로 번짐 | 중 | M3=정적 셸까지, drawer/active/터미널-prompt 동작은 M4로 명시 분리 |<!--mccp:resolved reason="resolved: M3 nav is static anchors only, drawer/active deferred to M4 (html.js:1348-1350)" at="2026-07-01T06:13:17.187Z"-->
| 좁은 viewport에서 nav 레일+카드 깨짐 | 중 | 구조적 collapse breakpoint + responsive-layout.test.js |<!--mccp:resolved reason="resolved: responsive @media max-width 880px nav reflow + single-column stack (responsive-layout.test)" at="2026-07-01T06:13:17.187Z"-->
