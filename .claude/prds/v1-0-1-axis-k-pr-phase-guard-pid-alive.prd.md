...
| 2 | Linux/macOS reproduction + W11 rubric 재측정 | W4 4d row가 Type E/NS=5 → ≤C/≤2 회복, Windows PowerShell 회귀 0, F11 schema 무손상 | complete | `.claude/plans/v1-0-1-axis-k-m2-cross-platform-verification.plan.md` |
