...
| 3 | 판정 어휘 사용자 친화화 | 대시보드 전 섹션의 dual-review 판정 라벨을 '수렴→통과', '진행→진행 중', 'divergent/미수렴→보류'로 일관 치환한다. | complete | .claude/plans/dashboard-readability-m3.plan.md |<!--mccp:resolved reason="readability M3가 PR #81(squash 96fae3a, v1.20.0 판정 어휘 SSoT 통일)로 실제 머지 완료 — PRD status in-progress는 stale이라 M3 plan 위험 5건이 계속 active로 오표시됨" at="2026-07-01T11:17:44.927Z"-->
